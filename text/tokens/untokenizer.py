...
class Untokenizer(object):
    ...
    def untokenize(cls, words):
        ...
        if len(symbol_stack) > 0:
            sys.stderr.write("WARNING: Lopsided punctuation symbols in "
                                + "string: " + string + "\n")
            sys.stderr.write("Symbol stack: " + symbol_stack + "\n")

        elif len(unexpected_symbols) > 0:
            sys.stderr.write("WARNING: Unexpected closing symbols "
                                + unexpected_symbols + " seen in string: "
                                + string + "\n")
