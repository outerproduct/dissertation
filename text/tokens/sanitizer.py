...
class Sanitizer(object):
    ...
    def reset_stored_tokens(self):
        ...
        # TODO: For Py3k, replace this with a proper dictionary comprehension
        self.tokens_by_type = dict((name,[]) for name in self.patterns.keys())
    ...
    def store_token(self, match):
        ...
        # dictionary
        self.tokens_by_type[self.current_pattern_name].append(current_token_idx)
...
# Patterns
    ...
    def _init_url_re(self):
        ...
        protocols = '(?:%s)' % '|'.join(('http', 'telnet', 'gopher', 'file',
                                         'wais','ftp'))
        tlds = '(?:%s)' % '|'.join(('aero','asia','biz','cat','com','coop',
                                    'edu', 'gov', 'info', 'int', 'jobs', 'mil',
                                    'mobi', 'museum', 'name', 'net', 'org',
                                    'pro', 'tel', 'travel', 'ac', 'ad', 'ae',
